  ...
  <div id="app">
      ...
      <ul class="product-list">
        <li class="product-list--product">
          <div class="ribbon" style="color: orangered;" />
            <img class="product-list--product--image" src="https://unsplash.it/400/250?image=407" alt=""/>
    ...
    <div class="container">
      <article class="product">
          <img class="product--image" src="https://unsplash.it/400/250?image=407" alt=""/>
          <div class="product--caption">
            <h1 class="product--name">
              Product title</h1>
            <div class="product--category">
              Category: <a href="#">aasd</a>
            </div>
    ...
    <div class="container">
      ...
      <form action="#" class="box product-edit">
        ...
        <div class="form-row">
          ...
          <img class="photo-preview" src="https://unsplash.it/400/250?image=407" />
        </div>
